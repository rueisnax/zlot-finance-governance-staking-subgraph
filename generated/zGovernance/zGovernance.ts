...
export class zGovernance extends ethereum.SmartContract {
  static bind(address: Address): zGovernance {
    return new zGovernance("zGovernance", address);
  }
  ...
  totalEarnedRewards(param0: Address): BigInt {
    let result = super.call(
      "totalEarnedRewards",
      "totalEarnedRewards(address):(uint256)",
      [ethereum.Value.fromAddress(param0)]
    );
  ...
  try_totalEarnedRewards(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "totalEarnedRewards",
      "totalEarnedRewards(address):(uint256)",
      [ethereum.Value.fromAddress(param0)]
  ...
  zLOT(): Address {
    let result = super.call("zLOT", "zLOT():(address)", []);

    return result[0].toAddress();
  }

  try_zLOT(): ethereum.CallResult<Address> {
    let result = super.tryCall("zLOT", "zLOT():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  zToken(): Address {
    let result = super.call("zToken", "zToken():(address)", []);

    return result[0].toAddress();
  }

  try_zToken(): ethereum.CallResult<Address> {
    let result = super.tryCall("zToken", "zToken():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
